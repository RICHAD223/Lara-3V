...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "XBwVSJ5K#cRnRyJeqqWIMpG_ALewSMiWMQxx-LmhsHJL9yn079UI", // Add your session id
...
AUTO_READ_STATUS: process.env.AUTO_READ_STATUS || "no-di",
